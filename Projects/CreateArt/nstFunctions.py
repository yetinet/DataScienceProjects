...
# content_image = '/Users/yeti/DataScienceProjects/Projects/ArtGeneration/images/lacroix.jpg'
# style_image = '/Users/yeti/DataScienceProjects/Projects/ArtGeneration/images/rainbow-image.jpg'

# Implement the model_nn() function which initializes
# the variables of the tensorf low graph, assigns the input image
# (initial generated image) as the input of the VGG16 model and
# runs the train_step for a large number of steps.
def model_nn(content_image, style_image, num_iterations=CONFIG.NUM_ITERATIONS):
    # vars
    ...
    with tf.Session() as sess:
        ...
        J = total_cost(J_content, J_style, CONFIG.ALPHA, CONFIG.BETA)
